...
class MegaApi {
  ...
  public String getUserAvatarColor(MegaUser user) {
    return megaJNI.MegaApi_getUserAvatarColor__SWIG_0(swigCPtr, this, MegaUser.getCPtr(user), user);
  }

  public String getUserAvatarColor(String userhandle) {
    return megaJNI.MegaApi_getUserAvatarColor__SWIG_1(swigCPtr, this, userhandle);
  }
